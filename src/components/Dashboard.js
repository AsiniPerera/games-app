...
// GameCard Component
function GameCard({ image, title, description, link, implemented }) {
  return (
    ...
    <div className="dashboard">
      ...
      <div className="game-card-container">
        <GameCard
          ...
          title="Tic Tac Toe"
          description="Play a strategic 5x5 grid match and enjoy!"
          link="/tic-tac-toe"
          implemented
        />
        <GameCard
        ...
        <GameCard
          ...
          description="Solve the puzzle by moving disks wisely and enjoy!"
          link="/hanoi"
          implemented
        />
        <GameCard
